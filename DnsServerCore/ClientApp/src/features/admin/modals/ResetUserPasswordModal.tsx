...
export const ResetUserPasswordModal: React.FC<ResetUserPasswordModalProps> = ({ isOpen, onClose, onSuccess, username }) => {
                                ...
                                <div className="mt-4">
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        <div>
                                            ...
                                            />
                                            <p className="text-xs text-slate-500 mt-1">A new password to reset the user account password.</p>
                                        </div>
                                        <div>
                                            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300">
